...
//                            Log.e(TAG, "onScrolled: "+headerLayout.getTranslationY()+"   "+headerLayout.getBottom()+"  -  "+headerLayout.getMeasuredHeight() );
    ...
    private void initData(){
        ...
        dishs1.add(new Dish("name1",1.0,10, R.drawable.twister));
        dishs1.add(new Dish("name2",1.0,10, R.drawable.twister));
        dishs1.add(new Dish("name3",1.0,10, R.drawable.twister));
        dishs1.add(new Dish("name4",1.0,10, R.drawable.twister));
        dishs1.add(new Dish("name5",1.0,10, R.drawable.twister));
        dishs1.add(new Dish("name6",1.0,10, R.drawable.twister));
        dishs1.add(new Dish("name7",1.0,10, R.drawable.twister));
        DishMenu breakfast = new DishMenu("BREAKFAST",dishs1, R.drawable.twister);

        ArrayList<Dish> dishs2 = new ArrayList<>();
        dishs2.add(new Dish("name8",1.0,10, R.drawable.twister));
        dishs2.add(new Dish("name9",1.0,10, R.drawable.twister));
        dishs2.add(new Dish("name10",1.0,10, R.drawable.twister));
        dishs2.add(new Dish("name11",1.0,10, R.drawable.twister));
        dishs2.add(new Dish("name12",1.0,10, R.drawable.twister));
        dishs2.add(new Dish("name13",1.0,10, R.drawable.twister));
        DishMenu launch = new DishMenu("LUNCH",dishs2, R.drawable.twister);

        ArrayList<Dish> dishs3 = new ArrayList<>();
        dishs3.add(new Dish("name14",1.0,10, R.drawable.twister));
        dishs3.add(new Dish("name15",1.0,10, R.drawable.twister));
        dishs3.add(new Dish("name16",1.0,10, R.drawable.twister));
        dishs3.add(new Dish("name17",1.0,10, R.drawable.twister));
        dishs3.add(new Dish("name18",1.0,10, R.drawable.twister));
        dishs3.add(new Dish("name",1.0,10));
        DishMenu evening = new DishMenu("DINNER",dishs3, R.drawable.twister);

        ArrayList<Dish> dishs4 = new ArrayList<>();
        dishs4.add(new Dish("name19",1.0,10, R.drawable.twister));
        dishs4.add(new Dish("name20",4.0,10, R.drawable.twister));
        dishs4.add(new Dish("name21",3.0,10, R.drawable.twister));
        dishs4.add(new Dish("name22",3.0,10, R.drawable.twister));
        dishs4.add(new Dish("name23",2.0,10, R.drawable.twister));
        dishs4.add(new Dish("name24",2.0,10, R.drawable.twister));
        DishMenu menu1 = new DishMenu("SNAKE",dishs4, R.drawable.twister);
